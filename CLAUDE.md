...
4. If `CLAUDE.md` was modified, automatically stages and amends the last commit, then exits 0 — git resolves the ref after the hook exits, so the amended commit is what gets pushed
